...
// import { data , terms } from './DummyData'
...
//                            <div> <p  className='text-white my-5 mx-3'><i class="fa-solid fa-earth-americas fa-xl me-3"></i>vista-kandivli.in</p></div>
//                           <div>  <p className='text-white my-5 mx-3'><i class="fa-solid fa-phone fa-xl"></i>+919967155511</p></div>
//                         </div>
...
//     </div>
//     <p onClick={handleNavigate} style={{ margin: '0px 0px 20px', fontSize: '14px', color: '#ddd' }}>By Clicking Submit, I Accept The <Link to="/T&C" onClick={()=>useNavigate(handleNavigate)}>Terms & Conditions</Link></p>
...
// <p style={{fontSize:'13px',lineHeight:'20px', textAlign:'center',paddingBottom:'20px', margin:'0 0 20px 0'}}>{terms.agentNo} &nbsp;|&nbsp;{terms.projectNo}</p>
// <hr />
        ...
        <div className="container-fluid" style={{ backgroundColor: "#dd0c2c" }}>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6">
                <div><p className='text-white my-5 mx-3'><i className="fa-solid fa-location-arrow fa-xl fw-bolder"></i> Kandivali West, Mumbai, Maharashtra</p></div>
                <div><p className='text-white my-5 mx-3'><i className="fa-solid fa-earth-americas fa-xl me-3"></i>vista-kandivli.in</p></div>
                <div><p className='text-white my-5 mx-3'><i className="fa-solid fa-phone fa-xl"></i>+919967155511</p></div>
              </div>
